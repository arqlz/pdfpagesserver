...
function PageEditor({docs}) {
  ...
  return React.createElement("div", {
    ...
    src: "imgs/outline_picture_as_pdf_black_24dp.png"
  }))))), React.createElement("div", {
    style: {
      background: "#313a46",
      padding: 10
...
function PageItemView({imagen, onDragOver, onDrop, onDragEnd, onRemove, onMove}) {
  ...
  function ondragover(e) {
    ...
    var id = (dataTransfer.types.map(c => c.split("/")).find(c => c[0] == "id") || [])[1];
  ...
  }, imagen.id))), React.createElement("div", {
    className: "column sideControls"
  }, React.createElement("button", {
    onClick: e => move(e, -1),
    className: "movebutton flex"
  }, React.createElement("img", {
    src: "imgs/outline_arrow_back_ios_white_24dp.png",
    className: "icon"
  })), React.createElement("button", {
    onClick: e => move(e, 1),
    className: "movebutton flex"
  }, React.createElement("img", {
    src: "imgs/outline_arrow_forward_ios_white_24dp.png",
    className: "icon"
  }))));
}
